...
import com.qdmh.studentsmartcardqdmh.client.app.Card.HelpMethod;
...
public class ChangeInfomationForm extends javax.swing.JDialog {
    ...
    public void init(){
        ...
        //jNgaySinh.set(student.getNgaysinh());
        // Chuyển đổi String sang Date để gán cho JDateChooser

        SimpleDateFormat dateFormat = new SimpleDateFormat("dd-MM-yyyy");
        try {
            Date ngaySinh = dateFormat.parse(student.getNgaysinh());
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        // Collect student info from the UI components
        ...
        // Attempt to update the student info
        boolean updated = card.updatePatientInfo(hoTen, ngaySinh, queQuan, gioiTinh, sdt, maBenhNhan);

        if (updated) {
            // save database
            HibernateService.updateInformation(student.getId(),hoTen,ngaySinh,maBenhNhan,sdt,gioiTinh,queQuan);
            //
            this.dispose();
...
// Display the current image first
        ...
        if (result == JFileChooser.APPROVE_OPTION) {
            ...
            try {
                ...
                // Preview the selected image without updating the student instance
