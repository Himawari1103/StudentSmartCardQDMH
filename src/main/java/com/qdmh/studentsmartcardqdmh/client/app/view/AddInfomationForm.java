...
//            Logger.getLogger(AddInfomationForm.class.getName()).log(Level.SEVERE, null, ex);
//        }
    }
...
//!TODO
        ...
        // save database
        // Attempt to update the student info on the smart card
        ...
        student.setId(idCard == 0 ? student.getId() : idCard);
        ...
        student.setMapin(maPin);
        // Update the student picture and display the image
        // !TODO
        ...
        // save public key
        // !TODO
        HibernateService.savePublicKey(student.getId(),card.getPatientPublicKey());
    }
