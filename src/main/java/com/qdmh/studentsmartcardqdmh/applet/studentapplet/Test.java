...
//
//    // Instance of the Student class to hold patient information
//    private static Student patient;
//
...
//    private static final byte VERIFY_PIN = (byte) 0x30; // Verify the pin in the charge and payment
//
...
////
////        // init for RSA
////        rsaSig = Signature.getInstance(Signature.ALG_RSA_SHA_256_PKCS1_PSS, false);
